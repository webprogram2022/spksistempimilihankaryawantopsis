...
class M_labor extends CI_Model
{
    ...
    {
        $alternatif = $this->db->get_where('alternatif', ['bidang' => 'labor'])->result_array();
        $dataHasil = [];
        $data = [];
    ...
    public function normalisasi_terbobot()
    {
        ...
        $bobotproses = $this->db->get_where('kriteria', ['bidang' => 'labor'])->result_array();
        foreach ($data as $i => $dt) {
            $arr = [];
            $arr['kode_alternatif'] = $alternatif[$i]['kode_alternatif'];
            $arr['nama_alternatif'] = $alternatif[$i]['nama_alternatif'];
