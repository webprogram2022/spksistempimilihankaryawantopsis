...
class M_supir extends CI_Model
{
    ...
    {
       $alternatif = $this->db->get_where('alternatif', ['bidang' => 'supir'])->result_array();
    ...
    public function normalisasi_terbobot()
    {
       $alternatif = $this->db->get_where('alternatif', ['bidang' => 'supir'])->result_array();
        ...
        $bobotproses = $this->db->get_where('kriteria', ['bidang' => 'supir'])->result_array();
        foreach ($data as $i => $dt) {
            $arr = [];
            $arr['kode_alternatif'] = $alternatif[$i]['kode_alternatif'];
            $arr['nama_alternatif'] = $alternatif[$i]['nama_alternatif'];
