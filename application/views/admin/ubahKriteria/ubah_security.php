    ...
    <div class="row">
        <div class="col-xl-12 col-lg-8">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="row m-1">
                        <form action="<?= base_url('admin/ubahKriteriaSecurity'); ?>" method="post">
                                ...
                                <tbody>
                                    <?php foreach ($security as $data) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="form-control" name="c5" value="<?= $data['c5']; ?>">
                                            </td>
                                            <td>
                                                <input type="text" class="form-control" name="c9" value="<?= $data['c9']; ?>">
                                            </td>
                                            <td>
                                                <input type="text" class="form-control" name="c10" value="<?= $data['c10']; ?>">
                                            </td>
                                            <td>
