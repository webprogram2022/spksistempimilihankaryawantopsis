    ...
    <div class="row">
        <div class="col-xl-12 col-lg-8">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="row m-1">
                        <form action="<?= base_url('admin/ubahKriteriaMaintenance'); ?>" method="post">
                                ...
                                <tbody>
                                    <?php foreach ($maintenance as $data) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="form-control" name="c12" value="<?= $data['c12']; ?>">
                                            </td>
                                            <td>
                                                <input type="text" class="form-control" name="c14" value="<?= $data['c14']; ?>">
                                            </td>
                                            <td>
