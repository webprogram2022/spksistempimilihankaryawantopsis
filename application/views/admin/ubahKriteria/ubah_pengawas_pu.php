    ...
    <div class="row">
        <div class="col-xl-12 col-lg-8">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="row m-1">
                        <form action="<?= base_url('admin/ubahKriteriaPengawasPu'); ?>" method="post">
                                ...
                                <tbody>
                                    <?php foreach ($pengawas_pu as $data) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="form-control" name="c6" value="<?= $data['c6']; ?>">
                                            </td>
                                            <td>
                                                <input type="text" class="form-control" name="c7" value="<?= $data['c7']; ?>">
                                            </td>
                                            <td>
