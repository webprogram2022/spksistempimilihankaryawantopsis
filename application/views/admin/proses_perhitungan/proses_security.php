                        ...
                        <div class="card shadow col-xl-12">
                            <table class="table table-bordered mb-2">
                                <tr>
                                    ...
                                    <td class="text-black font-weight-bold">C5</td>
                                    <td class="text-black font-weight-bold">C9</td>
                                    <td class="text-black font-weight-bold">C10</td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-black font-weight-bold">Keamanan</td>
                                    <td class="text-black font-weight-bold">Disiplin</td>
                                </tr>
                            </table>
                        </div>
                    </div>
                    ...
                    <div class="card shadow mb-2">
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between m-3">
                            <div class="text-left">
                                ...
                                <h5 class="text-bold">Bidang Security</h5>
                            </div>
                        </div>
