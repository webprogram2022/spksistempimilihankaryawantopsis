                        ...
                        <div class="card shadow col-xl-12">
                            <table class="table table-bordered mb-2">
                                <tr>
                                    ...
                                    <td class="text-black font-weight-bold">C6</td>
                                    <td class="text-black font-weight-bold">C7</td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-black font-weight-bold">Prestasi</td>
                                    <td class="text-black font-weight-bold">Pekerjaan Umum</td>
                    ...
                    <div class="card shadow mb-2">
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between m-3">
                            <div class="text-left">
                                ...
                                <h5 class="text-bold">Bidang Pengawas PU</h5>
                            </div>
                        </div>
