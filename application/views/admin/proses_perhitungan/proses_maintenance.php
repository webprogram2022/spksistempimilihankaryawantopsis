                        ...
                        <div class="card shadow col-xl-12">
                            <table class="table table-bordered mb-2">
                                <tr>
                                    ...
                                    <td class="text-black font-weight-bold">C12</td>
                                    <td class="text-black font-weight-bold">C14</td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-black font-weight-bold">Maintenance</td>
                                    <td class="text-black font-weight-bold">Breakdown</td>
                    ...
                    <div class="card shadow mb-2">
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between m-3">
                            <div class="text-left">
                                ...
                                <h5 class="text-bold">Bidang Maintenance</h5>
                            </div>
                        </div>
                        ...
                        <div class="card shadow mb-2">
                            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between m-3">
                                <div class="text-left">
                                    <h4>MATRIKS SOLUSI IDEAL POSITIF DAN NEGATIF</h4>
                                    <h5 class="text-bold">Bidang Maintenance</h5>
                                </div>
                            </div>
                            <div class="card shadow col-xl-11 m-3">
                                <table class="table table-striped">
                                    ...
                                    <tr class="font-weight-bolder text-black">
                                        <th colspan="" class="bg-info text-white text-center">
                                            Nilai A+
                                        </th>
                                        <?php foreach ($aPlus as $data) : ?>
                                            <td><?= round($data, 4); ?></td>
                                        <?php endforeach; ?>
                                    </tr>
                                    <tr class="font-weight-bolder text-black">
                                ...
                                <table class="table table-striped">
                                    ...
                                    <?php foreach ($max as $data) : ?>
                                        <tr class="font-weight-bolder text-black">
                                            ...
                                            <td><?= round($data['data_negatif'], 4); ?></td>
                                        </tr>
                                        <?php $i++; ?>
                                    <?php endforeach; ?>
                                </table>
                                ...
                                <table class="table table-striped">
                                    ...
                                    <?php foreach ($laporan as $data) : ?>
                                        <tr class="font-weight-bolder text-black">
                                            <td><?= $i; ?></td>
                                            <td><?= $data['kode_alternatif']; ?></td>
                                            <td><?= strtolower($data['nama_alternatif']); ?></td>
                                            <td><?= $data['jns_kelamin']; ?></td>
